...
const Token = () => {
    ...
    const columns = [
        ...
        {field: 'status', header: 'Total Supply'},
        {field: 'balance', header: 'Mint Amount'},
        {field: 'balance', header: 'Bitwork'},
        {field: 'balance', header: 'Holders'},
        {field: 'balance', header: 'Ongoing Mint'},
        {field: 'balance', header: 'Mint Now!'},
    ...
    return(
        <TokenWrapper>
            ...
            >
                ...
                <Column field="name" header="CirculatingSupply" />
                <Column field="name" header="TotalSupply" />
                <Column field="name" header="Amount Per Mint" />
                <Column field="name" header="Bitwork" />
                <Column field="name" header="Holders" />
                <Column header="Deployed" body={(row) => { return <Button rounded><i className='icon i-tabler-dashboard'></i><span>Fast Mint</span></Button> }} />
            </DataTable>
